  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text(
          'CHAT',
          style: TextStyle(color: Color(0xD91B5C), fontWeight: FontWeight.bold),
        ),
        centerTitle: true,
      ),
      body: new ChatScreen(
...
class ChatScreenState extends State<ChatScreen> {
        ...
        children: <Widget>[
          document['type'] == 0
              ...
              ? Container(
                  child: Text(
                    document['content'],
                    style: TextStyle(color: Color(0xD91B5C)),
                  ),
                        ...
                        child: CachedNetworkImage(
                          placeholder: Container(
                            child: CircularProgressIndicator(
                              valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF00ABCD)),
                            ),
                            width: 200.0,
                            height: 200.0,
  ...
  Widget buildListMessage() {
    return Flexible(
      child: groupChatId == ''
          ? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF00ABCD))))
          : StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return Center(
                      child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF00ABCD))));
                } else {
